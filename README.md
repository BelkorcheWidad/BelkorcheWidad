...
I enjoy building scalable, maintainable, and reliable backend systems. My interests include software architecture, distributed systems, and modern backend engineering, with a strong focus on clean architecture, code quality, and performance.
...
Backend service for a collaborative task management platform featuring secure authentication, real-time communication, RESTful APIs, and automated testing.

**Stack**

`Node.js` · `Express.js` · `PostgreSQL` · `Prisma ORM` · `Socket.IO` · `JWT` · `Jest`

---

### Audio Player

Cross-platform Flutter application with a clean architecture and modern audio playback experience.
