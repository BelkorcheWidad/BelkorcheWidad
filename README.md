...
| **[Chask](https://github.com/BelkorcheWidad/Task_Chat_Management)** | Backend service for a collaborative task management platform featuring authentication, real-time communication, RESTful APIs, automated testing, and CI/CD pipelines. | `Node.js` · `Express.js` · `PostgreSQL` · `Prisma ORM` · `Socket.IO` · `JWT` · `Jest` · `CI/CD` |
